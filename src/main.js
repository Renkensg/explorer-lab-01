...
// setCardType("default");
// A configuração abaixo substitui /a config acima, possibilitando a edição do cartão via Console, no DevTools. Exemplo: setCardType("visa")
